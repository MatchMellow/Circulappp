...
fun ItinerarioScreen(navController: NavHostController) {
    ...
    val offsetY = with(density) { (screenHeight * 0.575f).roundToPx() } // mesma altura proporcional: 57.5%
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        Column(
            ...
            Column(
                ...
                // Ícones Sobre nós e Contatos no topo
                Row(
                    modifier = Modifier
                        .fillMaxWidth()
            ...
            Column(
                ...
                // Agora "Voltar" está abaixo
                Button(
                    onClick = { navController.navigate("aposAs19hScreen") },
                    modifier = Modifier
                        .fillMaxWidth(0.55f)
                        .height(45.dp)
                        .offset(y = (-61).dp), // Ele sobe visualmente
                ...
                // Agora "Após às 19h" está acima
                Button(
                    onClick = { navController.popBackStack() },
                    modifier = Modifier
                        .fillMaxWidth(0.55f)
                        .height(45.dp)
                        .offset(y = (-45).dp), // Ele sobe visualmente
        ...
        // Botões "Aluno | Motorista" sobrepostos fora da coluna, posicionados com offset proporcional
        Box(
            modifier = Modifier
                .fillMaxWidth()
                .height(screenHeight * 0.08f) // 8% da altura da tela
                .offset { IntOffset(0, offsetY) }, // removi .align daqui
            contentAlignment = Alignment.TopStart // define alinhamento interno do conteúdo
        ) {
            Row(
                modifier = Modifier.fillMaxSize()
            ) {
